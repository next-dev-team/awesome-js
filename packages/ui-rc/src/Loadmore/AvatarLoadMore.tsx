...
export default function AvatarLoadMore() {
  ...
  return (
    <div className="max-w-xl mx-auto mt-8">
      <h1 className="text-2xl font-bold mb-4">Avatar Virtualized Load More</h1>
      <div
        ref={parentRef}
        ...
        >
          {rowVirtualizer.getVirtualItems().map((virtualRow) => {
            ...
            return (
              <div
                key={user.id}
                className="absolute left-0 w-full px-4 py-3 border-b bg-white flex items-center gap-4"
                style={{
                  top: 0,
