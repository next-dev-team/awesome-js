...
export default function ErrorStateExample() {
  ...
  const loadUsers = async () => {
    ...
    setError(null);
    try {
      // Intentionally use a wrong URL sometimes to simulate error
      const url = Math.random() < 0.3 ? 'https://gorest.co.in/public/v2/invalid' : 'https://gorest.co.in/public/v2/users';
  ...
  return (
    <div className="max-w-xl mx-auto mt-8">
      <h1 className="text-2xl font-bold mb-4">Error & Loading State Example</h1>
      <div
        ref={parentRef}
